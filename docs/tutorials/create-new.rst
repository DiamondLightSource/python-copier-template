...
Once you have followed the `./installation` tutorial, you can use ``copier``
...
You can now create a new blank project at <https://github.com/create>. Choose the same
GitHub owner and repo name that you answered in the questions earlier. GitHub will
now give you the commands needed to upload your repo from GitHub
